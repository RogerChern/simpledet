from models.KD.builder  import FitNetRetinaNet as Detector
from models.retinanet.builder import MSRAResNetV1bFPN as Backbone
from models.retinanet.builder import RetinaNetNeck as Neck
from models.retinanet.builder import RetinaNetHead as RpnHead
from models.KD.builder import FitNetHead as KDHead
...
def get_config(is_train):
    ...
    kd_head = KDHead(KDParam)
    detector = Detector()
    if is_train:
        train_sym = detector.get_train_symbol(backbone, neck, rpn_head, kd_head)
        test_sym = None
    else:
        train_sym = None
    ...
    class ModelParam:
        ...
        class teacher_param:
            prefix = 'teacher_model/retina_r152v1b_fpn_1x/checkpoint'
            epoch = 6
    ...
    scalar_metric = ScalarLoss(
        "fitloss",
        ["fit_loss_output"],
        []
    )

    metric_list = [rpn_acc_metric, scalar_metric]
