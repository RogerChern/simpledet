...
from models.kitti.builder import DilatedResNetV1bFPN as Backbone
...
def get_config(is_train):
    ...
    class DatasetParam:
        if is_train:
            image_set = ("kitti_train_all", )
        else:
            image_set = ("kitti_val_all", )
    ...
    class OptimizeParam:
        ...
        class schedule:
            begin_epoch = 0
            end_epoch = 10
            lr_iter = [3000 * 16 // (len(KvstoreParam.gpus) * KvstoreParam.batch_image)]
    ...
    class AnchorTarget2DParam:
        ...
        class _generate:
            def __init__(self):
                ...
                self.short = (144, 72, 36, 18, 9)
                self.long = (500, 250, 125, 63, 32)
            scales = (8)
            aspects = (0.5, 1.0, 2.0)
    ...
    from core.detection_input import ReadRoiRecord, Resize2DImageBbox, \
        ...
        RenameRecord, Norm2DImage, ReadImageRecord, Resize2DImage
