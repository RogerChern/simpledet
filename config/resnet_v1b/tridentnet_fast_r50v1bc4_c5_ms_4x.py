...
def get_config(is_train):
    ...
    class OptimizeParam:
        ...
        class warmup:
            type = "gradual"
            lr = 0.0
            iter = 5000 * 16 // (len(KvstoreParam.gpus) * KvstoreParam.batch_image)
    ...
    class ResizeParam:
        short_ranges = [640, 672, 704, 736, 768, 800] if is_train else [800]
    ...
    from core.detection_input import ReadRoiRecord, Resize2DImageBbox, \
        ...
        RenameRecord, Norm2DImage, RandResize2DImageBbox, Resize2DImageByRoidb
    ...
    if is_train:
        transform = [
            ...
            RandResize2DImageBbox(ResizeParam),
            Flip2DImageBbox(),
