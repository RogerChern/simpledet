...
from models.dilated.builder import DilatedResNetV1bC5 as Backbone
from models.dilated.builder import ASPP as Neck
from symbol.builder import RpnHead
from symbol.builder import RoiAlign as RoiExtractor
from symbol.builder import Bbox2fcHead as BboxHead
...
def get_config(is_train):
    ...
    class NeckParam:
        fp16 = General.fp16
        normalizer = NormalizeParam.normalizer
        use_relu_for_transform_conv = True
        use_relu_for_output_conv = False
