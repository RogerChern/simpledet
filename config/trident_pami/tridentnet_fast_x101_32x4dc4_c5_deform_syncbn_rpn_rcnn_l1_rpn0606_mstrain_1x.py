...
from models.tridentnet.builder_pami import TridentResNeXtC4 as Backbone
...
def get_config(is_train):
    ...
    class ModelParam:
        ...
        def process_weight(sym, arg_params, aux_params):
            ...
            for k in sym.list_arguments():
                branch_name = re.sub(r'_branch\d+', '', k)
        ...
        class pretrain:
            prefix = "pretrain_model/resnext%d_%dx%dd" % (BackboneParam.depth, BackboneParam.group, BackboneParam.channel_per_group)
            epoch = 0
            fixed_param = []
    ...
    from core.detection_input import ReadRoiRecord, Resize2DImageBbox, \
        ...
        RenameRecord, Norm2DImage, RandResize2DImageBbox, RandCrop2DImageBbox
