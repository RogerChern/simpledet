...
from models.tridentnet.builder_v2 import TridentResNetV1bDilatedC5 as Backbone
...
def get_config(is_train):
    ...
    class ModelParam:
        ...
        def process_weight(sym, arg_params, aux_params):
            # allow user to specify ndarray for symbol init
            ...
            for k in sym.list_arguments():
                if 'stage4' in k:
                    ...
                    arg_params[k] = arg_params[ksub]
                    logger.info('init arg {} with {}'.format(k, ksub))
            ...
            for k in sym.list_auxiliary_states():
                if 'stage4' in k:
                    ...
                    ksub = ksub.replace('stage4_unit2', 'stage3_unit5')
                    ksub = ksub.replace('stage4_unit3', 'stage3_unit6')
                    aux_params[k] = aux_params[ksub]
                    logger.info('init aux {} with {}'.format(k, ksub))
