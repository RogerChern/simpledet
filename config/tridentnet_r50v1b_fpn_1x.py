...
from models.tridentnet.fpn_builder import TridentResNetV1bFPN as Backbone
from models.tridentnet.fpn_builder import TridentFPNNeck as Neck
...
def get_config(is_train):
    ...
    class ModelParam:
        ...
        class pretrain:
            prefix = "pretrain_model/resnet-v1-%d" % BackboneParam.depth
            epoch = 0
            fixed_param = ["conv0", "stage1", "gamma", "beta"]

        def process_weight(sym, arg, aux):
            for stride in RpnParam.anchor_generate.stride[:-1]:
                add_anchor_to_arg(
