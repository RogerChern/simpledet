...
class NASFPNNeck(Neck):
    ...
    def get_fused_P_feature(self, p_features, stage, dim_reduced, init, norm):
        ...
        with mx.name.Prefix(prefix):
            ...
            P3_3 = X.reluconvbn(P3_3, dim_reduced, init, norm, name="P3_3", prefix=prefix)
            P3 = P3_3
            ...
            P4_4 = X.reluconvbn(P4_4, dim_reduced, init, norm, name="P4_4", prefix=prefix)
            P4 = P4_4
            ...
            P7_6 = X.merge_sum([gp_P5_5_P4_2, P7_0], name="sum_[gp_P5_5_P4_2]_P7_0")
            P7_6 = X.reluconvbn(P7_6, dim_reduced, init, norm, name="P7_6", prefix=prefix)
            P7 = P7_6
            ...
            P6_7 = X.reluconvbn(P6_7, dim_reduced, init, norm, name="P6_7", prefix=prefix)
            P6 = P6_7
