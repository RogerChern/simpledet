...
class DilatedResNeXtC4(Backbone):
    def __init__(self, pBackbone):
        super().__init__(pBackbone)
        p = self.p

        import mxnext.backbone.resnext_helper as helper
        num_c2, num_c3, num_c4, _ = helper.depth_config[p.depth]
        ...
        c2 = helper.resnext_c2(c1, num_c2, 1, p.c2_dil or 1, 32, 4, p.normalizer)
        c3 = helper.resnext_c3(c2, num_c3, 2, p.c3_dil or 1, 32, 4, p.normalizer)
        c4 = helper.resnext_c4(c3, num_c4, 2, p.c4_dil or 1, 32, 4, p.normalizer)
